    ...
    return (
        <div className={s.cardContainer} >
            <div className={s.likeContainer}>
                <button onClick={handleFavorite} className={` ${s.button} ${(favorite ? s.favoriteStatus : "")} `}><MdOutlineFavorite className={`${s.favorite} ${(favorite ? s.favoriteStatus : "")} ${s.favoriteActive} `} /></button>
            </div>
